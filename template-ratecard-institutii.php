<?php
/**
 * Template Name: Rate Card - Instituții Publice
 * Description: Template A4 Printable & Web pentru Oferta de Publicitate Instituții Publice & ONG.
 *
...
<style>
/* CSS Rate Card Document Premium - Verde Emerald Uniform */
.brz-rc-wrapper {
	max-width: 900px;
	...
	<div class="brz-rc-wrapper">
		...
		<div class="brz-rc-action-bar">
			<div style="font-weight: 700; font-size: 0.95rem;">
				🏛️ Rate Card Oficial — <strong>Instituții Publice &amp; ONG-uri</strong>
			</div>
		...
		<div class="brz-rc-doc">
			...
			<div class="brz-rc-header">
				<div>
					...
					<div class="brz-rc-doc-title">Oferta Comunicare Publică &amp; Transparență Cetățenească</div>
				</div>
				<div class="brz-rc-doc-meta">
					<strong>Cod Document:</strong> BRZ-RC-INSTITUTII-2026<br>
			...
			<div class="brz-rc-metrics">
				<div class="brz-rc-metric-box">
					<span class="brz-rc-metric-num">Transparență</span>
					<span class="brz-rc-metric-lbl">Informare Rapidă Cetățeni</span>
				</div>
				<div class="brz-rc-metric-box">
					<span class="brz-rc-metric-num">Comunicate</span>
					<span class="brz-rc-metric-lbl">Notificări &amp; Newsletter</span>
				</div>
				<div class="brz-rc-metric-box">
					<span class="brz-rc-metric-num">Sondaje</span>
					<span class="brz-rc-metric-lbl">Consultare Publică Forum</span>
				</div>
			</div>

			<!-- COMUTATOR TAB-URI PE MOBIL -->
			<div class="brz-rc-mobile-tabs">
				<button type="button" class="brz-rc-mobile-tab-btn" data-col="2">BASIC (300 LEI)</button>
				<button type="button" class="brz-rc-mobile-tab-btn active" data-col="3">STANDARD ⭐ (500 LEI)</button>
				<button type="button" class="brz-rc-mobile-tab-btn" data-col="4">PREMIUM (1.000 LEI)</button>
			</div>
			...
			<div class="brz-rc-table-wrapper">
				<table class="brz-rc-table show-col-3">
					<thead>
						<tr>
							<th style="width: 37%;">Serviciu Public / Beneficiu Inclus</th>
							<th style="width: 21%; text-align: center;">
								BASIC<br>
								<div style="font-size: 1rem; color: #10b981; font-weight: 900; margin-top: 4px;">300 LEI<span style="font-size: 0.75rem; font-weight: 600; color: #94a3b8;">/lună</span></div>
								<div style="font-size: 0.72rem; color: #94a3b8; font-weight: 600; text-transform: none;">3.000 lei / an</div>
							</th>
							<th style="width: 21%; text-align: center;" class="featured-col">
								STANDARD ⭐<br>
								<div style="font-size: 1.05rem; color: #ffffff; font-weight: 900; margin-top: 4px;">500 LEI<span style="font-size: 0.75rem; font-weight: 600; color: #a7f3d0;">/lună</span></div>
								<div style="font-size: 0.72rem; color: #a7f3d0; font-weight: 600; text-transform: none;">5.000 lei / an</div>
							</th>
							<th style="width: 21%; text-align: center;">
								PREMIUM<br>
								<div style="font-size: 1rem; color: #10b981; font-weight: 900; margin-top: 4px;">1.000 LEI<span style="font-size: 0.75rem; font-weight: 600; color: #94a3b8;">/lună</span></div>
								<div style="font-size: 0.72rem; color: #94a3b8; font-weight: 600; text-transform: none;">10.000 lei / an</div>
							</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td>Publicare Anunțuri Oficiale, Hotărâri Consiliu &amp; Înștiințări</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Pagină Dedicată Prezentare Instituție (Program Audiențe)</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Includere în Newsletter-ul Săptămânal al Comunei</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Publicare Rapoarte Activitate &amp; Comunicate în Prima Pagină</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Banner Informare Publică (Header sau In-Article)</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Comunicate de Presă Lunare cu Notificare Push</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;">2 / lună</td>
							<td style="text-align: center;">Nelimitat</td>
						</tr>
						<tr>
							<td>Secțiune Dedicată Dezbateri &amp; Sondaje Cetățenești Forum</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Banner Sticky Permanent de Utilitate Publică (300 x 600)</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Raport Lunar Detaliat de Audit &amp; Cititori Informați</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
			...
			<div id="brz-rc-order-form-box" class="brz-rc-form-box" style="background: #ffffff; border: 2px solid #047857; border-radius: 12px; padding: 30px; margin-top: 30px; box-shadow: 0 4px 20px rgba(4, 120, 87, 0.08);">
				<div style="text-align: center; margin-bottom: 24px;">
					<span style="background: #dcfce7; color: #15803d; font-size: 0.78rem; font-weight: 800; padding: 4px 14px; border-radius: 30px; text-transform: uppercase; letter-spacing: 0.5px; display: inline-block; margin-bottom: 8px;">
						🏛️ Solicitare Pachet Comunicare Publică
					</span>
					<h3 style="font-size: 1.5rem; font-weight: 900; color: #0f172a; margin: 0 0 6px 0;">
						Comandă Pachetul Dorit sau Solicită Ofertă Instituțională
					</h3>
					<p style="color: #64748b; font-size: 0.9rem; margin: 0; max-width: 650px; margin: 0 auto; line-height: 1.5;">
						Completează formularul de mai jos. Solicitarea ta va fi înregistrată instantaneu și echipa Brezoaele.ro te va contacta pentru confirmare și pregătirea acordului.
					</p>
				</div>

				<form id="brz-ratecard-order-form" method="post">
					<input type="hidden" name="req_category" value="Instituții Publice &amp; ONG" />
					...
					<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
						<div>
							...
							<select name="req_forma_juridica" required style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.95rem; background-color: #fff; box-sizing: border-box;">
								<option value="Instituție Publică" selected>Instituție Publică / Primărie / Consiliu Local</option>
								<option value="ONG / Asociație">O.N.G. / Asociație Non-Profit / Fundație</option>
								<option value="Școală / Liceu / Universitate">Unitate de Învățământ (Școală / Liceu / Universitate)</option>
								<option value="Companie de Utilități">Companie de Utilități / Regie Autonomă</option>
								<option value="Alta">Alta / Personalizat</option>
							</select>
						</div>
						<div>
							<label style="display: block; font-weight: 700; font-size: 0.85rem; margin-bottom: 6px; color: #0f172a;">Date Instituție / CIF / CUI / Sediu</label>
							<input type="text" name="req_date_companie" placeholder="ex: CIF 123456, Primăria / Asociația X" style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.95rem; box-sizing: border-box;" />
						</div>
					</div>

					<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
						<div>
							<label style="display: block; font-weight: 700; font-size: 0.85rem; margin-bottom: 6px; color: #0f172a;">Adresă Email Oficială *</label>
							<input type="email" name="req_email" required placeholder="contact@institutie.ro" style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.95rem; box-sizing: border-box;" />
						</div>
						<div>
							<label style="display: block; font-weight: 700; font-size: 0.85rem; margin-bottom: 6px; color: #0f172a;">Număr Telefon Contact *</label>
					...
					<div style="margin-bottom: 16px;">
						<label style="display: block; font-weight: 700; font-size: 0.85rem; margin-bottom: 6px; color: #0f172a;">Selector Pachet Reclamă / Informare Dorit *</label>
						<select id="brz-pkg-select" name="req_package" required style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.95rem; background-color: #fff; box-sizing: border-box;">
							<option value="Basic Instituții">Basic Instituții — 300 lei/lună</option>
							<option value="Standard Instituții" selected>Standard Instituții ⭐ — 500 lei/lună (Recomandat)</option>
							<option value="Premium Instituții">Premium Instituții — 1.000 lei/lună</option>
							<option value="Pachet Personalizat Instituții">Pachet Personalizat Instituțional</option>
						</select>
					</div>

					<div style="margin-bottom: 20px;">
						<label style="display: block; font-weight: 700; font-size: 0.85rem; margin-bottom: 6px; color: #0f172a;">Mesaj &amp; Cerințe Comunicare Publică (Obligatoriu) *</label>
						<textarea name="req_message" required rows="4" placeholder="Scrie obligatoriu ce campanie de informare publică sau anunțuri dorești (ex: publicații hotărâri, comunicate de presă, anunțuri utilitate publică), perioada vizată și detalii..." style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.92rem; box-sizing: border-box; resize: vertical;"></textarea>
					</div>
			...
			<div class="brz-rc-footer" style="margin-top: 30px;">
				...
				<div>
					<strong>Contact Direct:</strong> contact@brezoaele.ro
				</div>
			</div>
