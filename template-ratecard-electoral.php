<?php
/**
 * Template Name: Rate Card - Promovare Electorală
 * Description: Template A4 Printable & Web pentru Oferta de Promovare Electorală & Partide Politice.
 *
	...
	<div class="brz-rc-wrapper">
		...
		<div class="brz-rc-action-bar">
			<div style="font-weight: 700; font-size: 0.95rem;">
				🗳️ Rate Card Oficial — <strong>Promovare Electorală &amp; Partide Politice</strong>
			</div>
		...
		<div class="brz-rc-doc">
			...
			<div class="brz-rc-header">
				<div>
					...
					<div class="brz-rc-doc-title">Oferta Promovare Electorală &amp; Comunicat Politic</div>
				</div>
				<div class="brz-rc-doc-meta">
					<strong>Cod Document:</strong> BRZ-RC-ELECTORAL-2026<br>
					<strong>Conformitate:</strong> Legislație AEP &amp; Marcaj Electoral<br>
			...
			<div class="brz-rc-metrics">
				<div class="brz-rc-metric-box">
					<span class="brz-rc-metric-num">Promovare Legală</span>
					<span class="brz-rc-metric-lbl">Conformitate &amp; Marcaj AEP</span>
				</div>
				<div class="brz-rc-metric-box">
					<span class="brz-rc-metric-num">Audiență Județeană</span>
					<span class="brz-rc-metric-lbl">Alegători &amp; Cetățeni Activi</span>
				</div>
				<div class="brz-rc-metric-box">
					<span class="brz-rc-metric-num">Pachete Complete</span>
					<span class="brz-rc-metric-lbl">Advertoriale, Banners &amp; Video</span>
				</div>
			</div>

			<!-- COMUTATOR TAB-URI PE MOBIL -->
			<div class="brz-rc-mobile-tabs">
				<button type="button" class="brz-rc-mobile-tab-btn" data-col="2">BASIC (500 LEI)</button>
				<button type="button" class="brz-rc-mobile-tab-btn active" data-col="3">STANDARD ⭐ (1.000 LEI)</button>
				<button type="button" class="brz-rc-mobile-tab-btn" data-col="4">PREMIUM (2.500 LEI)</button>
			</div>
			...
			<div class="brz-rc-table-wrapper">
				<table class="brz-rc-table show-col-3">
					<thead>
						<tr>
							<th style="width: 37%;">Serviciu / Beneficiu Electoral Inclus</th>
							<th style="width: 21%; text-align: center;">
								BASIC<br>
								<div style="font-size: 1rem; color: #10b981; font-weight: 900; margin-top: 4px;">500 LEI<span style="font-size: 0.75rem; font-weight: 600; color: #94a3b8;">/lună</span></div>
								<div style="font-size: 0.72rem; color: #94a3b8; font-weight: 600; text-transform: none;">Perioadă Campanie</div>
							</th>
							<th style="width: 21%; text-align: center;" class="featured-col">
								STANDARD ⭐<br>
								<div style="font-size: 1.05rem; color: #ffffff; font-weight: 900; margin-top: 4px;">1.000 LEI<span style="font-size: 0.75rem; font-weight: 600; color: #a7f3d0;">/lună</span></div>
								<div style="font-size: 0.72rem; color: #a7f3d0; font-weight: 600; text-transform: none;">Perioadă Campanie</div>
							</th>
							<th style="width: 21%; text-align: center;">
								PREMIUM<br>
								<div style="font-size: 1rem; color: #10b981; font-weight: 900; margin-top: 4px;">2.500 LEI<span style="font-size: 0.75rem; font-weight: 600; color: #94a3b8;">/lună</span></div>
								<div style="font-size: 0.72rem; color: #94a3b8; font-weight: 600; text-transform: none;">Perioadă Campanie</div>
							</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td>Advertorial / Comunicat Electoral Marcat AEP</td>
							<td style="text-align: center;">1 Advertorial</td>
							<td style="text-align: center;">2 Advertoriale</td>
							<td style="text-align: center;">4 Advertoriale</td>
						</tr>
						<tr>
							<td>Banner Medium Rectangle (300 x 250 px) Sidebar Știri</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Profil Public Candidat / Formațiune Politică</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						...
						<tr>
							<td>Inserție Electorală Dedicată în Newsletter-ul Comunei</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Banner Billboard Prima Pagină Feed (970 x 250)</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						...
						<tr>
							<td>Banner În-Articol Ad (In-Article Ad) în toate știrile</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
						<tr>
							<td>Integrare Material Video de Prezentare Furnizat de Client</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center; color: #94a3b8;">—</td>
							<td style="text-align: center;"><span class="brz-rc-check">✓</span></td>
						</tr>
			...
			<div id="brz-rc-order-form-box" class="brz-rc-form-box" style="background: #ffffff; border: 2px solid #047857; border-radius: 12px; padding: 30px; margin-top: 30px; box-shadow: 0 4px 20px rgba(4, 120, 87, 0.08);">
				<div style="text-align: center; margin-bottom: 24px;">
					<span style="background: #dcfce7; color: #15803d; font-size: 0.78rem; font-weight: 800; padding: 4px 14px; border-radius: 30px; text-transform: uppercase; letter-spacing: 0.5px; display: inline-block; margin-bottom: 8px;">
						🗳️ Solicitare Pachet Promovare Electorală
					</span>
					<h3 style="font-size: 1.5rem; font-weight: 900; color: #0f172a; margin: 0 0 6px 0;">
						Comandă Pachetul Dorit sau Solicită Ofertă Electorală
					</h3>
					<p style="color: #64748b; font-size: 0.9rem; margin: 0; max-width: 650px; margin: 0 auto; line-height: 1.5;">
						Completează formularul de mai jos. Solicitarea ta va fi înregistrată instantaneu și echipa Brezoaele.ro te va contacta conform reglementărilor AEP.
					</p>
				</div>

				<form id="brz-ratecard-order-form" method="post">
					<input type="hidden" name="req_category" value="Promovare Electorală" />
					...
					<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
						<div>
							...
							<select name="req_forma_juridica" required style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.95rem; background-color: #fff; box-sizing: border-box;">
								<option value="Partid Politic" selected>Partid Politic / Formațiune Electorală</option>
								<option value="Candidat Independent">Candidat Independent</option>
								<option value="Alianță Politică">Alianță Politică / Electorală</option>
								<option value="SRL">S.R.L. / Mandatar Financiar</option>
								<option value="Alta">Alta / Personalizat</option>
							</select>
						</div>
						<div>
							<label style="display: block; font-weight: 700; font-size: 0.85rem; margin-bottom: 6px; color: #0f172a;">Cod CMF / CUI / Date Partid sau Candidat</label>
							<input type="text" name="req_date_companie" placeholder="ex: Cod CMF AEP, CUI Mandatar Financiar" style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.95rem; box-sizing: border-box;" />
						</div>
					</div>

					<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
						<div>
							<label style="display: block; font-weight: 700; font-size: 0.85rem; margin-bottom: 6px; color: #0f172a;">Adresă Email Contact *</label>
							<input type="email" name="req_email" required placeholder="campanie@partid.ro" style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.95rem; box-sizing: border-box;" />
						</div>
						<div>
					...
					<div style="margin-bottom: 16px;">
						<label style="display: block; font-weight: 700; font-size: 0.85rem; margin-bottom: 6px; color: #0f172a;">Selector Pachet Promovare Electorală Dorit *</label>
						<select id="brz-pkg-select" name="req_package" required style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.95rem; background-color: #fff; box-sizing: border-box;">
							<option value="Basic Electoral">Basic Electoral — 500 lei/lună</option>
							<option value="Standard Electoral" selected>Standard Electoral ⭐ — 1.000 lei/lună (Impact Local)</option>
							<option value="Premium Electoral">Premium Electoral — 2.500 lei/lună</option>
							<option value="Pachet Personalizat Electoral">Pachet Personalizat Campanie</option>
						</select>
					</div>

					<div style="margin-bottom: 20px;">
						<label style="display: block; font-weight: 700; font-size: 0.85rem; margin-bottom: 6px; color: #0f172a;">Mesaj &amp; Cerințe Campanie Electorală (Obligatoriu) *</label>
						<textarea name="req_message" required rows="4" placeholder="Scrie obligatoriu ce materiale dorești să promovezi (ex: advertoriale program politic, bannere candidat, promovare video), perioada de desășurare și specificații..." style="width: 100%; padding: 12px 14px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; font-size: 0.92rem; box-sizing: border-box; resize: vertical;"></textarea>
					</div>
			...
			<div class="brz-rc-footer" style="margin-top: 30px;">
				<div>
					© <?php echo date( 'Y' ); ?> Brezoaele.ro • Servicii furnizate de <strong>ECOMPLEX.RO SRL</strong> (Neplătitor de TVA — TVA 0%). Toate materialele sunt marcate conform normelor AEP.
				</div>
				<div>
