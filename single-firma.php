		...
		?>
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> style="max-width: 960px; margin: 0 auto;">
				...
				<div style="display: grid; grid-template-columns: 2fr 1fr; gap: 16px; align-items: start;">
					<!-- Coloana Stângă: Prezentare -->
					<div>
						<?php if ( has_post_thumbnail() ) : ?>
							<div style="margin-bottom: 16px; border: 1px solid var(--color-border); border-radius: var(--border-radius-lg); overflow: hidden;">
								<?php the_post_thumbnail( 'large', array( 'style' => 'width:100%; height:auto; display:block;' ) ); ?>
							</div>
						<?php endif; ?>

						<div class="card" style="padding: 20px; font-size: 0.95rem; line-height: 1.7;">
							<h3 style="margin-bottom: 12px; border-bottom: 2px solid var(--color-border); padding-bottom: 6px; font-size: 1.15rem; font-weight: 800; font-family: var(--font-heading);">DESPRE NOI</h3>
					...
					<!-- Coloana Dreaptă: Informații Contact & Localizare -->
					<div style="display: flex; flex-direction: column; gap: 16px;">
						...
						<?php if ( ! empty( $lat ) && ! empty( $lng ) ) : ?>
							<div class="card" style="padding: 16px;">
								...
								<div id="single-map" style="height: 250px; border: 1px solid var(--color-border); border-radius: var(--border-radius-md); overflow: hidden; z-index: 10;"></div>
							</div>
						<?php endif; ?>
					</div>
				</div>
